...
export default function FacultyAnnouncements() {
  ...
  const fetchAnnouncements = async () => {
    try {
      ...
      console.error(err);
      setErrorMsg('Failed to load notices feed.');
    } finally {
      setLoading(false);
    }
  };
  ...
  // Delete notice (restricted to author or Admin)
  const handleDeleteNotice = async (id) => {
    ...
    try {
      ...
      console.error(err);
      setErrorMsg('Failed to delete notice. Access denied.');
    }
  };
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
      <div>
        ...
        <p className="text-secondary" style={{ fontSize: '0.9rem' }}>
          Post department bulletins and view school-wide notice feeds.
        </p>
      </div>
      ...
      <div style={{
        ...
        <div className="glass-panel" style={{ padding: '30px' }}>
          ...
          <p className="text-secondary" style={{ fontSize: '0.85rem', marginBottom: '20px' }}>
            Notices will automatically bind to your assigned department ({user?.departmentCode || 'General'}) and will be visible on student dashboard notice feeds.
          </p>
        ...
        <div className="glass-panel" style={{ padding: '30px' }}>
          <h4 style={{ marginBottom: '20px' }}>Department Bulletin Board</h4>
          {loading ? (
